...
if("TRUE" STREQUAL "TRUE")
  set(husky_bringup_SOURCE_PREFIX /home/sbclab/SBAB/src/husky/husky_bringup)
  set(husky_bringup_DEVEL_PREFIX /home/sbclab/SBAB/devel)
  ...
  set(husky_bringup_INSTALL_PREFIX /home/sbclab/SBAB/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'husky_bringup' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sbclab/SBAB/src/husky/husky_bringup/${idir}'.  ${_report}")
    endif()
