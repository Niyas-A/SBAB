...
if("TRUE" STREQUAL "TRUE")
  set(man_cntrl_SOURCE_PREFIX /home/sbclab/SBAB/src/man_cntrl)
  set(man_cntrl_DEVEL_PREFIX /home/sbclab/SBAB/devel)
  ...
  set(man_cntrl_INSTALL_PREFIX /home/sbclab/SBAB/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'man_cntrl' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sbclab/SBAB/src/man_cntrl/${idir}'.  ${_report}")
    endif()
